...
| `amerge` re-arms **after** the yield | `amerge` | tightens the bound to exactly one produced-but-unconsumed item per source, rather than two ([§5.5](./part-1-the-derivation.md#55-backpressure-survives-the-merge)) |
